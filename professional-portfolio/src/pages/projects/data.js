...
const projects = [
  ...
  },
  {
    ...
    imagePath: readmeGen,
    alt:
      "This is an app designed to dynamically create README.md files based on user inputs. The generated files will include a title, description, and table of contents with links to each of the following sections: Installation, Usage, Licensing, Credits, How to Contribute, Testing, Questions",
